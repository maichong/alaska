...
exports.default = (() => {
  var ref = _asyncToGenerator(function* () {
    ...
    if (this.isMain()) {
        ...
        app.use((() => {
          var ref = _asyncToGenerator(function* (ctx, next) {
            ...
            ctx.__defineSetter__('session', function (val) {
              ...
              if (typeof val === 'object') return session = new _session2.default(ctx, val);
      ...
      app.use((() => {
        var ref = _asyncToGenerator(function* (ctx, next) {
          ...
          var _ref = yield (0, _asyncBusboy2.default)(ctx.req);
          ...
          files.forEach(function (file) {
            ...
            if (ctx.files[fieldname]) {
              if (_lodash2.default.isArray(ctx.files[fieldname])) {
    ...
    let templatesDir = _path2.default.join(this.dir, this.config('templates')) + '/';
    ...
    app.use(function (ctx, next) {
      ...
      ctx.t = function (message, locale, values) {
        if (_lodash2.default.isObject(locale)) {
          values = locale;
          locale = null;
        }
        if (!locale) {
      ...
      ctx.render = function (template, locals) {
        ...
        return new Promise(function (resolve, reject) {
          service.engine.renderFile(path, _lodash2.default.assign({}, ctx.locals, locals), function (error, result) {
            if (error) {
              reject(error);
              return;
            }
