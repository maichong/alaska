...
class Service {
  ...
  constructor(options, alaska) {
    ...
    (0, _collie2.default)(this, 'route', require('./service/route').default);
    (0, _collie2.default)(this, 'loadAppMiddlewares', require('./service/loadAppMiddlewares').default);
   ...
   */
  applyConfig(config) {
    this._config = _lodash2.default.assign({}, this._config, config);
  }
