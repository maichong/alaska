...
class Sled {
  ...
  send(timeout, notify) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let id = _this2.id;
      if (!id) {
        id = _this2.id = 'sled.' + key + '.' + random(10);
      }
  ...
  wait(waitTimeout, sledTimeout) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let id = _this3.id;
      if (!id) {
        id = _this3.id = 'sled.' + _this3.key + '.' + random(10);
      }
  ...
  run() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (_this5.constructor._pre) {
        yield collie.compose(_this5.constructor._pre, [], _this5);
      }
      ...
      if (_this5.constructor._post) {
        yield collie.compose(_this5.constructor._post, [result], _this5);
      }
